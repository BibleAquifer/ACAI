...
*seed-bearing* (3x), *with seed* (2x), *seed* (11x), *is seed* (1x), *seed for* (1x), *and barley* (2x), *the barley* (2x), *the seed* (1x), *When you reap* (2x), *of your field* (1x), *and you reap* (1x), *a sheaf* (2x), *the sheaf* (3x), *reap* (3x), *to reap* (3x), *your seed* (3x), *to the seed required for it fifty shekels* (1x), *whether from the seed* (1x), *of barley* (11x), *of grain* (1x), *and his seed* (1x), *barley* (8x), *the produce* (1x), *both the crop* (1x), *you are harvesting* (1x), *barley bread* (1x), *of the barley* (2x), *the harvesters* (4x), *to the harvesters* (1x), *his harvesters* (1x), *The foreman* (1x), *among the sheaves* (1x), *they are harvesting* (1x), *the sheaves* (2x), *barley and* (1x), *measures of barley* (1x), *were harvesting* (1x), *of your grain* (1x), *at the beginning* (1x), *of seed* (3x), *and reap* (1x), *20,000 baths* (1x), *reap the same* (1x), *They gather* (1x), *your grain* (1x), *will reap* (1x), *of the reaper* (1x), *will reap disaster* (1x), *and harvests* (1x), *came the grain* (1x), *for the seed* (1x), *you will plant* (1x), *reaper with* (1x), *but harvested* (1x), *with the seed* (1x), *and* (2x), *crops* (1x), *beans* (1x), *as you would a barley* (1x), *some of the seed* (1x), *it in fertile* (1x), *and a lethech* (1x), *and they shall reap* (1x), *and reap the fruit* (1x), *and reaped* (1x), *and the* (1x), *The mountains* (1x). 


In the New Testament (BSB), words representing “Barley” are translated as 
*seed* (5x), *barley* (2x), *store of seed* (1x), *for a* (1x). 
...
* seed (GEN 1:29; GEN 47:19; EXO 16:31; LEV 11:37; LEV 27:16; NUM 11:7; DEU 28:38; ISA 55:10; JER 2:21; JER 35:7; HAG 2:19)
...
* of the barley (RUT 1:22; 2SA 21:9)
...
* seed (MRK 4:26; MRK 4:27; LUK 8:5; LUK 8:11; 2CO 9:10)
