...
Thematic Lexica (for Realia, Flora, and Realia). These references allowed the aggregation of the bulk of the available
...
We have aggregated as much Realia data as possible from the UBS Hebrew and Greek Dictionaries and supplemented with
references in the UBS Images. We hope to be able to utilize some of the information in the UBS Thematic Lexicon for 
Realia to provide a more complete picture of Realia in the Bible. The Realia encoded are not comprehensive, but are 
useful as-is and should be considered a draft. 
...
<tr><td>type</td><td>string</td><td>for realia, `realia` is the only valid type</td></tr>
